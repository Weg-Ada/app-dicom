...
class ExaminationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create examination" do
    assert_difference('Examination.count') do
      post examinations_url, params: { examination: { examinated_at: @examination.examinated_at, name: @examination.name, path: @examination.path, patient_id: @examination.patient_id } }
    end
  ...
  test "should update examination" do
    patch examination_url(@examination), params: { examination: { examinated_at: @examination.examinated_at, name: @examination.name, path: @examination.path, patient_id: @examination.patient_id } }
